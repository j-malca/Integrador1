...
<tbody>
	 <tr rowspan="3">
	 	...
	 	<td ><button type="button" class="btn btn-secondary btn-lg btn-block">Administracion</button></td>
	 </tr>
 	 <tr rowspan="3">
 	 	<td><button type="button" class="btn btn-warning btn-lg btn-block">Pase </button></td>
