...
<div class="col-md-4 mb-3">
   ...
   <label for="Elegir Ubicacion">Elegir Ubicacion</label>
    <select class="custom-select" id="ubic" name="ubic" required>
        ...
        <option value="2">Edifcio Principal</option>
    ...
    <%
		...
		String respu10 = request.getParameter("resput8");
                ...
                try {
                    ...
                    con = DriverManager.getConnection("jdbc:mysql://localhost/dbscovid?user=root&password=");
                    st=con.createStatement();
                    st.executeUpdate("insert into REGISTRO_FORMULARIO (id_trabajador, id_ubicacion, id_pregunta1,id_pregunta2,id_pregunta3,id_pregunta4,id_pregunta5,id_pregunta6,id_pregunta7,id_pregunta8,id_pregunta9,id_pregunta10,respuesta_formulario_1,respuesta_formulario_2,respuesta_formulario_3,respuesta_formulario_4,respuesta_formulario_5,respuesta_formulario_6,respuesta_formulario_7,respuesta_formulario_8,respuesta_formulario_9,respuesta_formulario_10,fecha_registro)"
                            + " values('1','"+ubi+"',"
